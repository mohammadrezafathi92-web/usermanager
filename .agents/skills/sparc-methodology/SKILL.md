...
npx @Codex-flow/cli@latest sparc modes

# Get help for specific mode
npx @Codex-flow/cli@latest sparc help <mode>

# Run with options
npx @Codex-flow/cli@latest sparc run <mode> "task" --parallel --monitor

# Execute TDD workflow
npx @Codex-flow/cli@latest sparc tdd "feature description"

# Batch execution
npx @Codex-flow/cli@latest sparc batch <mode1,mode2,mode3> "task"

# Pipeline execution
npx @Codex-flow/cli@latest sparc pipeline "task description"
```
...
npx @Codex-flow/cli@latest sparc run researcher "authentication patterns"

# Step 2: Architecture design
npx @Codex-flow/cli@latest sparc run architect "design auth system"

# Step 3: TDD implementation
npx @Codex-flow/cli@latest sparc tdd "user authentication feature"

# Step 4: Code review
npx @Codex-flow/cli@latest sparc run reviewer "review auth implementation"

# Step 5: Documentation
npx @Codex-flow/cli@latest sparc run documenter "document auth API"
```
...
npx @Codex-flow/cli@latest sparc run analyzer "investigate bug #456"

# Step 2: Debug systematically
npx @Codex-flow/cli@latest sparc run debugger "fix memory leak in service X"

# Step 3: Create tests
npx @Codex-flow/cli@latest sparc run tester "regression tests for bug #456"

# Step 4: Review fix
npx @Codex-flow/cli@latest sparc run reviewer "validate bug fix"
```
...
npx @Codex-flow/cli@latest sparc run analyzer "profile API response times"

# Step 2: Identify bottlenecks
npx @Codex-flow/cli@latest sparc run optimizer "optimize database queries"

# Step 3: Implement improvements
npx @Codex-flow/cli@latest sparc run coder "implement caching layer"

# Step 4: Benchmark results
npx @Codex-flow/cli@latest sparc run tester "performance benchmarks"
```
...
npx @Codex-flow/cli@latest sparc pipeline "e-commerce checkout feature"
...
# Run specific mode
npx @Codex-flow/cli@latest sparc run <mode> "task"

# TDD workflow
npx @Codex-flow/cli@latest sparc tdd "feature"

# Full pipeline
npx @Codex-flow/cli@latest sparc pipeline "task"

# Batch execution
npx @Codex-flow/cli@latest sparc batch <modes> "task"
```
