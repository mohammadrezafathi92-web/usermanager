...
npx @Codex-flow/cli@latest github release-create \
  --version "2.0.0" \
  --build-artifacts \
...
npx @Codex-flow/cli@latest sparc pipeline "Release v2.0.0 with full validation"
```
...
npx @Codex-flow/cli@latest github changelog \
  --prs "$PRS" \
  --commits "$COMMITS" \
  --from v1.0.0 \
  --to HEAD \
...
npx @Codex-flow/cli@latest github version-suggest \
  --current v1.2.3 \
  --analyze-commits \
  --check-compatibility \
  --suggest-pre-release
...
npx @Codex-flow/cli@latest github release-test \
...
npx @Codex-flow/cli@latest github release-deploy \
...
npx @Codex-flow/cli@latest github multi-release \
...
npx @Codex-flow/cli@latest github performance-test \
  --baseline v1.9.0 \
  --candidate v2.0.0 \
...
npx @Codex-flow/cli@latest github rollback-config \
  --triggers '{
    "error-rate": ">5%",
    "latency-p99": ">1000ms",
    "availability": "<99.9%",
...
npx @Codex-flow/cli@latest github release-compliance \
